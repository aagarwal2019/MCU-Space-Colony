            ...
            {assignedHero ? (
              <div className="flex items-center justify-between p-2.5 rounded-lg bg-slate-900 border border-slate-800">
                <div className="flex items-center gap-2.5">
                  <div 
                    className={`w-8 h-8 rounded-lg bg-gradient-to-br ${assignedHero.avatarColor} flex items-center justify-center text-white font-bold font-display text-xs`}
                  >
                    {assignedHero.heroName.substring(0, 2).toUpperCase()}
                  </div>
                  <div>
